    ...
    if (!summary) {
        return (
            <div className="journey-loading">
                ...
                <div className="journey-loading__card" />
                <div className="journey-loading__card" />
                <span>Building your performance profile...</span>
            </div>
        );
    }
        ...
        <div className="journey-page">
            <header className="journey-header">
                <div className="journey-title">
                    ...
                    <p>Reveal long-term patterns across ratings, openings, mistakes, and accuracy from your cross-platform chess history.</p>
                </div>
            ...
            <section className="journey-hero">
                <div className="journey-identity">
                    ...
                    <div>
                        <div className="journey-identity__name">Your Performance Profile</div>
            ...
            <section className="journey-timeline">
                <div className="section-header">
                    <div>
                        ...
                        <p>
                            Long-term rating movement scoped to the selected format.
                    ...
                    <div className="journey-chart-card">
                        ...
                        {perfCounts.length === 0 ? (
                            <div className="timeline-empty">
                                <Activity size={20} />
                                <h3>No games found</h3>
                                <p>Connect games to build your performance profile.</p>
                            </div>
                        ) : (
                            <ResponsiveContainer width="100%" height={240}>
            ...
            <footer className="journey-footer">
                ...
                <div>Measurable progress with every move.</div>
            </footer>
                ...
                >
                    <div className="journey-share-dialog">
                        <div className="journey-share-header">
                            <div>
                                <div className="journey-share-title">Share your Progress</div>
